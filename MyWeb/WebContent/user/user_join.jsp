	...
	<div align="center" class="div_center">
		...
		<form action="joinForm.user" method="post" name="reg_form">
			<table border="1">
				...
				<tr>
					<td>이메일</td>
					<td><input type="text" name="email" placeholder="abc@def.com">
					</td>
				</tr>
				<tr>
					<td>주소</td>
			...
			<input type="button" value="회원가입" class="btn btn-default"
				onclick="joinConfirm()"> &nbsp;&nbsp; <input type="button"
				value="로그인" class="btn btn-default"
				onclick="location.href='login.user'">
		</form>
	</div>
